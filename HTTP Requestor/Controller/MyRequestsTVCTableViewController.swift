//
//  MyRequestsTVCTableViewController.swift
//  HTTP Requestor
//
//  Created by Hanlon Miller on 4/20/19.
//  Copyright © 2019 Hanlon Miller. All rights reserved.
//
...
class MyRequestsTVCTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "HTTPRequest")
        
        do {
            storedHttpRequests = try managedContext.fetch(fetchRequest)
        } catch let error as NSError {
